...
namespace Haita_de_lupi
{
    public partial class Form4 : Form
    {
        ...
        private void Alex_KeyDown(object sender, KeyEventArgs e)
        {
            if (miscare == true)
            {
                ...
                if (lupp1.Bounds.IntersectsWith(Alex.Bounds) && g == 'd')
                    miscarelup3();
                if (lupp1.Bounds.IntersectsWith(Alex.Bounds) && lup3.IsDisposed == false && g == 'd')
                    miscare = false;
        ...
        private async void miscarelup3()
        {
            int bubu = 0;
        ...
        private async void Alex_KeyPress(object sender, KeyPressEventArgs e)
        {
            ...
            if (Alex.Bounds.IntersectsWith(hitbox1.Bounds) || Alex.Bounds.IntersectsWith(hitbox2.Bounds) || Alex.Bounds.IntersectsWith(hitbox3.Bounds) || Alex.Bounds.IntersectsWith(hitbox4.Bounds) || Alex.Bounds.IntersectsWith(hitbox5.Bounds) || Alex.Bounds.IntersectsWith(hitbox6.Bounds) || Alex.Bounds.IntersectsWith(hitbox7.Bounds) || Alex.Bounds.IntersectsWith(hitbox8.Bounds) || Alex.Bounds.IntersectsWith(hitbox9.Bounds) || Alex.Left <= 0 || Alex.Top >= 500 || Alex.Top <= 0)
            {
                if (e.KeyChar == 'w')
                    Alex.Top = Alex.Top + v;
                if (e.KeyChar == 's')
